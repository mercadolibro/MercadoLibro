...
<div id="container">
  <div id="header">
    <h1 align="center">Guardado Correctamente
  <!-- end #header -->
    </h1>
  </div>
  <p align="center">El Cliente se ha registrado satisfactoriamente</p>
  <p align="center"><img src="./imagenes/bien.png" width="169" height="165" /></p>
  <p align="center">
    <label>
      <input type="button" Onclick="volver()" name="btnVolver" value="Volver" />
    </label>
  </p>
